...
class Data extends AbstractHelper
{
     ...
     * @param \Myparcelasia\Shipping\Api\Myparcelasia $myparcelasiaApi
     */
    public function __construct(
        \Magento\Framework\App\Helper\Context $context,
        \Magento\Framework\App\CacheInterface $cache,
        \Myparcelasia\Shipping\Api\Myparcelasia $myparcelasiaApi,
        \Myparcelasia\Shipping\Helper\Config $configHelper
    ) {
        parent::__construct($context);

        $this->cache        = $cache;
        $this->myparcelasiaApi      = $myparcelasiaApi;
    ...
    {
        try {
            $this->myparcelasiaApi->getUserTokenValidity($token);
    ...
    {
        $locationCacheId = "mpa_shipping_locations_{$postalCode}";
        ...
        $place = $this->myparcelasiaApi->getPostcodeLocations($postalCode);
    ...
    {
        $dateCacheId = "mpa_shipping_pick_up_dates_{$postalCode}";
        ...
        $dateListing = $this->myparcelasiaApi->getPickupDateListing($postalCode);
    ...
    {
        try {
            return (float)$this->myparcelasiaApi->checkEWalletBalance();
